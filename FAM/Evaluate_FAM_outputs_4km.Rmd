...
## load TOC data
mertz.toc.dat <- read.csv("C:/Users/jjansen/Desktop/science/data_biological/Circumpolar_TOC_data_CEAMARC_sediment_isotopes.csv")
mertz.toc.locs <- project(as.matrix(mertz.toc.dat[,2:3]),proj=ant.proj)
ross.toc.dat <- read.csv("C:/Users/jjansen/Desktop/science/data_biological/Circumpolar_TOC_data_villinski_2008.csv")
...
#### Extract flux values at Diatom locations
## Mertz region
surf.vals.m <- extract(surf_08,mertz.toc.locs)
susp.vals.m <- extract(susp_08,mertz.toc.locs)
settle.vals.m <- extract(settle_08,mertz.toc.locs)
...
```{r}
sel <- match(substr(mertz.toc.dat$ï..Station,1,6),substr(mertz.diatom.dat$Sample,1,6))
...
toc.vals.m <- mertz.toc.dat[,7]
## Ross region
surf.vals.r <- extract(surf_08,ross.toc.locs)
susp.vals.r <- extract(susp_08,ross.toc.locs)
settle.vals.r <- extract(settle_08,ross.toc.locs)
