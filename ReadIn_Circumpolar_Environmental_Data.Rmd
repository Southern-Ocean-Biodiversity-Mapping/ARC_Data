...
file.curr  <- "Circumpolar_EnvData_waom2k"
```

#### 2. for bathymetry: choose which data-layer to use, which resolution and projection, which depth range.
...
if(data.name=="ibcso"){
  ra.res.depth <- "500m"
  if(data.depth=="shelf"){
    ra.res.depth <- "500m_shelf"
  }
}

if(data.name=="gebco"){
  if(data.depth=="full"){
    if(data.format=="projected.raw"){ ## original resolution (119m x 460m)
      ra.res.depth <- ""
    }
    if(data.format=="projected.500"){ ## 500m resolution
      ra.res.depth <- "500m"      
    }
  }
  if(data.depth=="shelf"){
...
save.string <- paste0(env.derived, file.bathy, ra.res.depth, "_", data.name)

writeRaster(r.depth, filename=paste0(save.string,"_depth.Rdata"), overwrite=TRUE)
writeRaster(r.slope, filename=paste0(save.string,"_slope.Rdata"), overwrite=TRUE)
writeRaster(r.tpi,   filename=paste0(save.string,"_tpi.Rdata"), overwrite=TRUE)
writeRaster(r.tpi5,  filename=paste0(save.string,"_tpi5.Rdata"), overwrite=TRUE)
writeRaster(r.tpi11, filename=paste0(save.string,"_tpi11.Rdata"), overwrite=TRUE)
```
...
#writeRaster(r.bathy_smaller, filename=paste0(env.derived,file.bathy,ra.res.depth,"_",data.name,"Weddell.Rdata"), overwrite=TRUE)
```
...
## load data:
npp.list$npp_2002 <- get(load(paste0(env.derived,file.npp,"_filled_2002.Rdata")))
npp.list$npp_2003 <- get(load(paste0(env.derived,file.npp,"_filled_2003.Rdata")))
npp.list$npp_2004 <- get(load(paste0(env.derived,file.npp,"_filled_2004.Rdata")))
npp.list$npp_2005 <- get(load(paste0(env.derived,file.npp,"_filled_2005.Rdata")))
npp.list$npp_2006 <- get(load(paste0(env.derived,file.npp,"_filled_2006.Rdata")))
npp.list$npp_2007 <- get(load(paste0(env.derived,file.npp,"_filled_2007.Rdata")))
npp.list$npp_2008 <- get(load(paste0(env.derived,file.npp,"_filled_2008.Rdata")))
npp.list$npp_2009 <- get(load(paste0(env.derived,file.npp,"_filled_2009.Rdata")))
npp.list$npp_2010 <- get(load(paste0(env.derived,file.npp,"_filled_2010.Rdata")))
npp.list$npp_2011 <- get(load(paste0(env.derived,file.npp,"_filled_2011.Rdata")))
npp.list$npp_2012 <- get(load(paste0(env.derived,file.npp,"_filled_2012.Rdata")))
npp.list$npp_2013 <- get(load(paste0(env.derived,file.npp,"_filled_2013.Rdata")))
npp.list$npp_2014 <- get(load(paste0(env.derived,file.npp,"_filled_2014.Rdata")))
npp.list$npp_2015 <- get(load(paste0(env.derived,file.npp,"_filled_2015.Rdata")))
npp.list$npp_2016 <- get(load(paste0(env.derived,file.npp,"_filled_2016.Rdata")))
npp.list$npp_2017 <- get(load(paste0(env.derived,file.npp,"_filled_2017.Rdata")))
npp.list$npp_2018 <- get(load(paste0(env.derived,file.npp,"_filled_2018.Rdata")))
npp.list$npp_2019 <- get(load(paste0(env.derived,file.npp,"_filled_2019.Rdata")))
npp.list$npp_2020 <- get(load(paste0(env.derived,file.npp,"_filled_2020.Rdata")))
...
writeRaster(npp_su, filename=paste0(env.derived,"Circumpolar_EnvData_NPP_SummerAverage.Rdata"))
```
...
writeRaster(uv,           filename=paste0(env.derived,file.curr,"_seafloorcurrents.Rdata"))
writeRaster(uv_500,       filename=paste0(env.derived,file.curr,"_seafloorcurrents_500mInterpolation.Rdata"))
writeRaster(uv_500_shelf, filename=paste0(env.derived,file.curr,"_seafloorcurrents_500mInterpolation_shelf.Rdata"))
writeRaster(t,            filename=paste0(env.derived,file.curr,"_seafloortemperature.Rdata"))
writeRaster(t_500,        filename=paste0(env.derived,file.curr,"_seafloortemperature_500mInterpolation.Rdata"))
writeRaster(t_500_shelf,  filename=paste0(env.derived,file.curr,"_seafloortemperature_500mInterpolation_shelf.Rdata"))
