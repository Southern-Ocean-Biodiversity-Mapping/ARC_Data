...
sel_S <- grep("Sp",dataset.names)
sel_O <- grep("Oc",dataset.names)
sel_B <- grep("Bry",dataset.names)
sel_M <- grep("Mo",dataset.names)
sel_E <- grep("Ech",dataset.names)
sel_Asc <- grep("Asc",dataset.names)
...
sel_noid.cov <- grep("Unknown",dataset.names)
