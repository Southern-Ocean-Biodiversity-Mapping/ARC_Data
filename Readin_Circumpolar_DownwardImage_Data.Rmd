...
__"Circumpolar_DownwardImages_locations.Rdata"__  
...
*  polar sterographic projection used: __stereo__
...
bio.dir <-      paste0(ARC_Data.dir,"ReadIn_Circumpolar_DownwardImage_Data_And_Subset_Surveys/")
...
# #### load diatom data
# load(file=paste0(bio.dir,"Circumpolar_Diatom_locations.Rdata"))
...
#### load image data
## Ross Sea
dat.0802 <- get(load(paste0(bio.dir,"TAN0802_dat.Rdata")))
...
dat.1802 <- get(load(paste0(bio.dir,"TAN1802_dat.Rdata")))
t.l.1802 <- t.l
total.t.length.v.1802 <- total.t.length.v
dat.1901 <- get(load(paste0(bio.dir,"TAN1901_dat.Rdata")))
t.l.1901 <- t.l
total.t.length.v.1901 <- total.t.length.v
dat.NBP1502 <- get(load(file=paste0(bio.dir,"NBP1502_dat.Rdata")))
total.t.length.v.NBP1502 <- total.t.length.v
t.l.NBP1502 <- t.l
## West Antarctic
dat.PS81 <- get(load(file=paste0(bio.dir,"PS81_dat_FINAL.Rdata")))
total.t.length.v.PS81 <- total.t.length.v
dat.PS81_shallow <- get(load(file=paste0(bio.dir,"PS81_dat_shallow.Rdata")))
total.t.length.v.PS81_shallow <- total.t.length.v
dat.PS96 <- get(load(file=paste0(bio.dir,"PS96_dat_FINAL.Rdata")))
total.t.length.v.PS96 <- total.t.length.v
dat.PS118 <- get(load(file=paste0(bio.dir,"PS118_dat.Rdata")))
total.t.length.v.PS118 <- total.t.length.v
## CRS
dat.WAP <- get(load(file=paste0(bio.dir,"CRS_dat.Rdata")))
total.t.length.v.WAP <- total.t.length.v
## East Antarctic
dat.NBP1402 <- get(load(file=paste0(bio.dir,"NBP1402_dat.Rdata")))
total.t.length.v.NBP1402 <- total.t.length.v
rm(dat,t.l,total.t.length.v)
## old Weddell Sea surveys
dat.PS06 <- get(load(file=paste0(bio.dir,"PS06_dat.Rdata")))
dat.PS14 <- get(load(file=paste0(bio.dir,"PS14_dat.Rdata")))
total.t.length.v.PS14 <- total.t.length.v
dat.PS18 <- get(load(file=paste0(bio.dir,"PS18_dat.Rdata")))
total.t.length.v.PS18 <- total.t.length.v
dat.PS61 <- get(load(file=paste0(bio.dir,"PS61_dat.Rdata")))
total.t.length.v.PS61 <- total.t.length.v
## Mertz
dat.AA2011 <- get(load(file=paste0(bio.dir,"AA2011_dat.Rdata")))
## SUCS
dat.JR262 <- get(load(file=paste0(bio.dir,"JR262_dat.Rdata")))
dat.JR15005 <- get(load(file=paste0(bio.dir,"JR15005_dat.Rdata")))
total.t.length.v.JR15005 <- total.t.length.v
dat.JR17001 <- get(load(file=paste0(bio.dir,"JR17001_dat.Rdata")))
total.t.length.v.JR17001 <- total.t.length.v
dat.JR17003 <- get(load(file=paste0(bio.dir,"JR17003_dat.Rdata")))
total.t.length.v.JR17003 <- total.t.length.v
## LMG1311
dat.LMG1311 <- get(load(file=paste0(bio.dir,"LMG1311_dat.Rdata")))
...
save(polar.dat.0802,
     ...
     stereo,
     file=paste0(ARC_Data.dir,"Circumpolar_DownwardImages_locations.Rdata"))
```
