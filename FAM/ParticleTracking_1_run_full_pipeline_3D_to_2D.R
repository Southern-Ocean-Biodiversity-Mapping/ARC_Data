...
ptrackr_dir <- "/home/ubuntu/ARC_Data/FAM/ptrackR_package_update2026/R/"
npp.dir <- "/pvol/data_environmental/derived/NPP/"
raw_dir3 <- "/pvol3TB/data_environmental/raw/ROMS_2k_files/"
env_dir3 <- "/pvol3TB/data_environmental/"
out_dir  <- "/pvol3TB/FAM_outputs/"
final_out_dir <- "/pvol/DropboxData/data_environmental/derived/FAM_outputs/"
...
for(z in 2:4){
  ...
  # Reduce ROMS depth layers before 2D
  ...
  #                    file.path(final_out_dir, paste0("tracking3D_",npp.model,"_NPP9_", speed, "mday_21days_bottomnpp_circumpolar.tif")),
  #                    overwrite = TRUE)
