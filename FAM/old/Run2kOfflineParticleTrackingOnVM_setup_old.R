...
#   for(i in 1:2){
#     u.raw.ra.loop[[i]][] <- c(u.raw[,2800:1,i,k])
#   }
...
for(k in 1:2){
  ...
  for(i in 1:31){
    print(i)
     v.raw.ra.loop[[i]][] <- c(v.raw[,2799:1,i,k])
  }
...
rm(v.vals.array)
ROMS_2k$i_w <- w.raw[,2800:1,-32,1:2]
rm(w.raw)
...
save(ROMS_2k, file=paste0(env.dir,"ocean_his_0001_2slices_TrackingSetup.Rdata"))
####################################################
